                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="feditorderdetail.php" method="post">
                                    <input type="hidden" name="id" value="<?= $id ?>">
                                    <input type="hidden" name="order_id" value="<?= $order_id ?>">
                                    <span class="input-group-text">Quantity</span>
                                    <input class="form-control" type="text" name="quantity" value="<?= $quantity ?>">
                                    <span class="input-group-text">Customer_id</span>
                                    <input class="form-control" type="text" name="customer_id" value="<?= $customer_id ?>">
                                    <span class="input-group-text">Price</span>
                                    <input class="form-control" type="text" name="priceEach" value="<?= $priceEach ?>">
                                    <span class="input-group-text">Order Comment</span>
                                    <input class="form-control" type="text" name="order_comment" value="<?= $order_comment ?>">
