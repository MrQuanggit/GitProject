                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="fupdateuser.php" method="post">
                                    ...
                                    <input class="form-control" type="text" name="user_password" value="<?= $user_password ?>">
                                    <span class="input-group-text">Roles</span>
                                    <input class="form-control" type="text" name="roles" value="<?= $roles ?>">
                                    <input class="input-group-text" type="submit" value="Update User">
                                </form>
                            </div>
                        </div>
                    </div>
